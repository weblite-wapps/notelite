...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _setup_server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../setup/server */ \"./setup/server.js\");\n/* harmony import */ var _db__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./db */ \"./logic/db.js\");\n// components\n\n// db helpers\n\n\n_setup_server__WEBPACK_IMPORTED_MODULE_0__[\"default\"].post('/saveNote', ({ body: { id, text } }, res) => Object(_db__WEBPACK_IMPORTED_MODULE_1__[\"saveNote\"])(id, text).then(note => res.end()).catch(err => res.send(err)));\n_setup_server__WEBPACK_IMPORTED_MODULE_0__[\"default\"].get('/loadNote/:id', ({ params: { id } }, res) => Object(_db__WEBPACK_IMPORTED_MODULE_1__[\"loadNote\"])(id).then(note => res.send(note)).catch(err => res.send(err)));\n\n//# sourceURL=webpack:///./logic/route.js?");
